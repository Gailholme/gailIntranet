...
function fncSubmit()
{
	if(document.frmAdd.txtPid.value == "1")
	{
		alert('Please input Professor ID');
		document.frmAdd.txtPid.focus();
		return false;
	}	
	if(document.frmAdd.txtPname.value == "")
	{
...
<table width="600" border="1">
  ...
  ?>
  <tr>
    <td><div align="center"><input type="text" name="txtPid<?php echo $i;?>" size="5"></div></td>
